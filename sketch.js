...
function setup() {
  ...
  whale2 = createSprite(200,height/2,width/10,height-10);
  ...
  restart = createSprite(950,height/2);
  restart.addImage(restartImg);
  restart.visible = false;
  restart.scale = 0.5;

  gameOver = createSprite(950,height/3);
...
function draw() {
  ...
  textSize(20);
  fill("white");
  text("Score: "+ score,width-200,45);


  text("UnderWaterWhaleGame  Version:2.1",850,45)
