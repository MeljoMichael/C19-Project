...
function setup() {
  ...
  whale2 = createSprite(width-1760,height/2,width/10,height-10);
  ...
  restart = createSprite(width-1000,height/2);
  restart.addImage(restartImg);
  restart.visible = false;

  gameOver = createSprite(width-1000,height/4);
...
function draw() {
  ...
  text("UnderWaterWhaleGame  Version:2.0",width-1150,height-940)
